...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resource/css/allstyle.css"/>">
...
<body>
	...
	<div class="header-child">
		...
		<img
				src="<c:url value="/resource/images/extra.png"/>"
				
				href="<c:url value="/home"/>" width="70px" height="70px"
		...
		<div id="title" class = "header-title">
				...
				<a id ="titlelink" href="<c:url value="/home" />" >Extra Store</a>
